        ...
        <div class="nav-items">
            ...
            @if (\Auth::check())
                ...
                @php
                    ...
                    //dddx(\Auth::user()->perm->perm_type === 5);
                @endphp
                ...
                @can('creaUtente', Panel::getHomePanel())
                    <li><a dusk='menu-crea-utente'
                            href="{{ url(route('container0.index', ['container0' => 'profile'])) }}">Gestione Utenti</a>
                    </li>
                @endcan
